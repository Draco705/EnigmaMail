...
usage () {
	echo "Usage: ./magicUnicorn.sh [mode] [arguments]"
	echo "Mode 1: Send & Encrypt"
	echo "./magicUnicorn.sh 1 inputFileName recipientAddress senderAddress"
	echo "Mode 2: Encrypt"
	echo "./magicUnicorn.sh 2 inputFileName"
	echo "Mode 3: Decrypt"
	echo "./magicUnicorn.sh 3 inputFileName"
}
